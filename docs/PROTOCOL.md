> **Note :** notes de rétro-ingénierie d'origine de [NicRoss512](https://github.com/NicRoss512/ASUS-ROG-Strix-Flare-II-Animate-AniMe-Matrix-Protocol), conservées telles quelles. Depuis, la lecture des GIF/images est implémentée (voir le [README](../README.md)) ; les services d'exemple ci-dessous sont remplacés par `animematrix-galerie.service` et `animematrix-horloge.service`.
