...
| GIF/이미지 | 효과 | 오디오 | 설정 |
|---|---|---|---|
| ![GIF 탭](../captures/ko/gif.png) | ![효과 탭](../captures/ko/effets.png) | ![오디오 탭](../captures/ko/audio.png) | ![설정 탭](../captures/ko/reglages.png) |
...
- **그래픽 런처** (`animematrix`), 4개의 탭으로 구성:
  ...
  - **설정** : 세션 시작 시 표시할 항목, 드로잉 편집기, 프로젝트 링크.
