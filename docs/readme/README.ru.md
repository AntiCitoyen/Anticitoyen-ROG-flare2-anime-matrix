...
| GIF / изображения | Эффекты | Аудио | Настройки |
|---|---|---|---|
| ![Вкладка GIF](../captures/ru/gif.png) | ![Вкладка «Эффекты»](../captures/ru/effets.png) | ![Вкладка «Аудио»](../captures/ru/audio.png) | ![Вкладка «Настройки»](../captures/ru/reglages.png) |
...
- **Графический лаунчер** (`animematrix`) с четырьмя вкладками:
  ...
  - **Настройки**: что отображать при входе в сессию, язык интерфейса, редактор рисунка, ссылки проекта.
...
- **Эффекты** и **Аудио**: выбрать, настроить, *▶ Запустить эффект*. Ползунки действуют в реальном времени; *Скорость* ускоряет или замедляет анимацию.
