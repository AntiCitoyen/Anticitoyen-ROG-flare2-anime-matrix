...
*Налаштування* → *🌈 Кольори клавіатури…*: ефект (веселка, статичний, дихання, зміна кольорів, реакція, брижі, зоряна ніч, сипучі піски, течія, дощ), кольори, швидкість, яскравість, напрямок. *Спробувати* застосовує його, *Записати в клавіатуру* зберігає після відключення. *Колір теми* і *Пульсацію з екраном* демон надсилає по клавішах; після їх вимкнення повертається записаний ефект. У командному рядку: `animematrix-ctl rgb arc-en-ciel --vitesse 70`, `animematrix-ctl rgb statique --couleur "#ff0000"`.
